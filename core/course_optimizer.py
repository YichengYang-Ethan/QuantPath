...
_FACTOR_CATEGORY_MAP: list[dict[str, Any]] = [
    ...
    _f("cs", "ml_course", 0.10, {"machine_learning", "reinforcement_learning"}),
    _f("cs", "numerical_computing", 0.07, {"numerical_analysis"}),
    _f("cs", "reinforcement_learning", 0.02, {"reinforcement_learning"}),
    _f("cs", "software_engineering", 0.08, {"software_engineering"}),
...
_PREREQ_CATEGORY_MAP: dict[str, set[str]] = {
    ...
    "machine_learning": {"machine_learning", "stat_learning", "reinforcement_learning"},
